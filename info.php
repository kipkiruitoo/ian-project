             ...
             <div class="card card-panel z-depth-4 teal white-text hoverable center lighten-1">
                <div class="card-content black-text">
                    <h1>Error</h1>
                        ...
                        <a href="customer.php"><button class="btn white black-text hoverable "/>Order</button></a>
                         <a href="kitchen.php"><button class="btn white black-text hoverable "/>View Order</button></a>
                </div>
            </div>
        </div>
    </div>
