                ...
                <div class="widget-content">
                  ...
                  <div class="padd">
                             ...
                             <div class="support-contact">
                                ...
                                <p><i class="fa fa-phone"></i>&nbsp; Phone<strong>:</strong> 435-1114</p>
                                <hr />
                                <p><i class="fa fa-envelope"></i>&nbsp; Email<strong>:</strong> chimneycatering@yahoo.com</p>
                                <hr />
                                <p><i class="fa fa-home"></i>&nbsp; Address<strong>:</strong> Mabini St., Fisheries Avenue, Talisay City </p>
                <hr />
        <p><i class="fa fa-facebook"></i>&nbsp; Facebook<strong>:</strong> facebook.com/chimneycatering </p>
                <hr />              
                                <!-- Button -->
